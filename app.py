...
strNewestActivity = '『臺南市新吉工業區廠協會』：最近活動\n' + \
                '更新：2020/01/06(四) 14:32 ...\n\n' + \
                '[B] 廠協會LOGO投票：請點選Google表單 \n' + \
                'https://forms.gle/7ZJ7REJKRj321iJ97 \n\n' + \
                '(A) 廠協會年初全體會員活動：概念階段 \n' + \
                '(B) 廠協會LOGO：投票階段(1/10中午止) \n' + \
                '(C) 廠協會背心：設計階段 \n' + \
...
def handle_message(event):
    ...
    elif ('最近' in temp_messag or '最新' in temp_message) and ('訊息' in temp_message or '活動' in temp_message):
